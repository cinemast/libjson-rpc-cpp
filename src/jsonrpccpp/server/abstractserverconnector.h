...
public:
  ...
  /**
   * This method should send a response to the client in any way that is
   * appropriate for the derived connector class.
   * @param response - the response that should be send to the client
   * @param addInfo - additional Info, that the Connector might need for
   * responding.
  ...
  /**
   * This method must be called, when a request is recognised. It will do
   * everything else for you (including sending the response).
