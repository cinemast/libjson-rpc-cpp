...
namespace jsonrpc
{
    RpcProtocolServer::RpcProtocolServer(AbstractRequestHandler* server, procedurelist_t *procedures) :
        procedures(procedures),
        server(server)
    {
    }

    RpcProtocolServer::RpcProtocolServer(AbstractRequestHandler* server) :
